  ...
  <div class="container-fluid">
    ...
    <div class="card card-cosmetic">
      ...
      <div class="card-header header-cosmetic">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="d-flex gap-2">
            ...
            <!-- TAMBAH -->
            <a href="dashboard.php?menu=addkategori"
      ...
      <div class="card-body p-0">
        <table class="table table-hover table-cosmetic mb-0 text-center" id="kategoriTable">
          <thead style="background:#fff0f6">
            <tr>
              <th width="100">NO</th>
              <th width="200">ID KATEGORI</th>
              <th>NAMA KATEGORI</th>
          ...
          <tr>
            ...
            <td>
              <a href="dashboard.php?menu=editkategori&id_kategori=<?= $d['id_kategori'] ?>"
                 class="btn btn-action btn-edit"
                 title="Edit Kategori">
                <i class="bi bi-pencil-fill"></i>
              </a>

              <a href="form/kategori/hapus.php?id_kategori=<?= $d['id_kategori'] ?>"
